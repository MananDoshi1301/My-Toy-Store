...
const Footer = () => {
  ...
  const list2 = ["Store locator", "New arrivals", "Brands", "Customer Care"];
  ...
  return (
    <>
      <motion.div
              ...
              <div className="col-lg-4">
                <div className="row">
                  <div className="col-lg-6">
                    ...
                    >
                      <h5>MyToyStore</h5>
                      {list1.map((listItem, key) => {
                        return <li key={key} className="my-1">{listItem}</li>;
                      })}
                    </ul>
                  </div>
                  <div className="col-lg-6">
                ...
                <div className="icons">
                  <div className="row">
                    <div className="col-lg-4 m-0 p-0 ">
                      ...
                      <div className="detail fs-5">Premium <br />Quality</div>
                    </div>
                    <div className="col-lg-4 m-0 p-0">
                      <div className="icon">
                        <svg
        ...
        <div className="footerStrip px-5 fs-4 fw-bold container-fluid">
          <div className="row">
            <div className="col-lg-5">
              &copy; MyToyStore 2021 All Rights Reserved.
            </div>
            <div className="col-lg-5 offset-lg-2 text-center">
              <div className="row">
                <div className="col-lg-6 text-end">Follow Us On:</div>
